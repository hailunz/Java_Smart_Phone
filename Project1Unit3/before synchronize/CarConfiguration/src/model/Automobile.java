...
public class Automobile implements Serializable{
    ...
    public float testGetOptionChoicePrice(String setName){
        try{
            Thread.sleep(5000);
        }catch (Exception e){
    ...
    public void testSetOptionChoice( String setName, String optionName){
    ...
    public  void testUpdateOption(String opset, String opt, String name, float price){
        OptionSet set = findOpset(opset);
        if (set!=null){
            set.updateOptions(opt,name, price);
        }
