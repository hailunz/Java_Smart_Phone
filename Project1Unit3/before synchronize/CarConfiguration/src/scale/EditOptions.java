...
import adapter.EditOptionThread;
 ...
 * Date: 9/24/15
 */
public class EditOptions extends Thread implements EditOptionThread{

    public String id;
    private EditOptionThread t;
    private int editOption;
    private String modelname;

    public EditOptions(String id, EditOptionThread t1, int editOption, String modelname){
        super(id);
        this.id = id;
        this.t = t1;
    ...
    @Override
    public void updateOptionChoicePrice(String modelname, String OptionSet, float newprice) {
    ...
    @Override
    public void addOptionChoicePrice(String modelname, String OptionSet,
            float add) {
