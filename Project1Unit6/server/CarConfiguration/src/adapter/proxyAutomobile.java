...
public abstract class proxyAutomobile {
    ...
    private String dbFile = "dbSetting.txt";
    ...
    public void BuildAuto(String filename) {
        ...
        try {
            AddModel am = new AddModel(this.dbFile);
            am.addMobile(a1);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void updateOptionSetName(String modelname,
        ...
        if (a!=null){
            ...
            try {
                UpdateTable ut = new UpdateTable(this.dbFile);
                ut.updateOptionSetName(modelname,OptionSetname,newName);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public void updateOptionPrice(String modelname, String OptionSet,
        ...
        if (a!=null) {
            ...
            try {
                UpdateTable ut = new UpdateTable(this.dbFile);
                ut.updateOptionPrice(modelname,OptionSet,Option,newprice);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public void updateOptionName(String modelname, String Optionname,
                                 String Option, String newName){
        Automobile a = mobileMap.get(modelname);
        if (a!=null) {

           a.updateOptionName(Optionname,Option, newName);
            try {
                UpdateTable ut = new UpdateTable(this.dbFile);
                ut.updateOptionName(modelname,Optionname,Option,newName);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public void delete(String modelname) throws Exception {
        this.mobileMap.remove(modelname);
        DeleteModel dm = new DeleteModel(this.dbFile);
        dm.delete(modelname);
    }
}
