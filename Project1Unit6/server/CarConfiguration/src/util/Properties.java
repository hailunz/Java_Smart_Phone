...
public class Properties implements Serializable{
    ...
    private Hashtable<String, String> buildProp;
    private Automobile auto;

    public Properties(){
        this.properties = new Hashtable<>();
        this.choices = new Hashtable<>();
        this.buildProp = new Hashtable<>();
    }
    ...
    public void loadDB(String filename) throws Exception {
        FileReader file = file = new FileReader(filename);
        ...
        while (!eof) {
            ...
            if (line == null)
                ...
                String[] args = line.split("=");
                this.buildProp.put(args[0],args[1]);
            }
        }
        buff.close();
        file.close();
    ...
    public String getSetting(String name){
        return this.buildProp.get(name);
    }
}
