...
public class Automobile implements Serializable{
    ...
    private static final long serialVersionUID = 3176626233549533579l;
    ...
    public void addOptionSet(String setName, int size){
        synchronized (this){
            this.opset.add(new OptionSet(setName,size));
        }
    }
    //Setter
    ...
    public HashMap<String,List<String>> getOptionSetString(){
        HashMap<String, List<String>> map = new HashMap<>();
        for(OptionSet o : this.opset){
            map.put(o.getName(), o.getOptionList());
        }
        return map;
    }
